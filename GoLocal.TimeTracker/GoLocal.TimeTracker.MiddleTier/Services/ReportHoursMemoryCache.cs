...
{
    public class ReportHoursMemoryCache : ICacheService<ListCollectionPage<ReportHours>>
    {
        private readonly ILogger _logger;
        private readonly TimeTrackerOptions _timeTrackerOptions;
        private readonly IMemoryCache _memoryCache;
        private readonly int _cacheTime;
        private const string _cacheKey = "_rh";

        public ReportHoursMemoryCache(
            ILogger<ReportHoursMemoryCache> logger,
            ...
            IMemoryCache memoryCache)
        {
            ...
            _cacheTime = _timeTrackerOptions.WorkHoursCacheMinutes; // TODO: Add setting for this one in timetrackeroptions
        }
