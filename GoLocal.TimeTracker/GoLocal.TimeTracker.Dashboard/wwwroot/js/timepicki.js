		...
		var defaults = {
			format_output: function(tim, mini, meri) {
			    if (settings.show_meridian) {
			        ...
			        tim = Math.min(Math.max(parseInt(tim), 1), 10000);
			        if (tim < 10)
			            tim = "0" + tim;
			        ...
			        tim = Math.min(Math.max(parseInt(tim), 0), 10000);
			    ...
			    function validate() {
			        ...
			        if (grandfatherDiv.hasClass("time")) { /// HOUR
			            ...
			            if (isValidNumber) {
                            ...
                            Math.min(Math.max(parseInt(input.val()), -1000), 10000) : // for 12 hour date picker.
			                Math.min(Math.max(parseInt(input.val()), -1000), 10000); // for 24 hours date picker.
