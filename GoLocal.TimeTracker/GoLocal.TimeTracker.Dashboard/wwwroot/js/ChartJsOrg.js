            ...
            o.prototype = {
                ...
                mix: function (t, e) {
                    var a = this,
                        ...
                        s = 1 - l;
                    return this.rgb(l * a.red() + s * i.red(), l * a.green() + s * i.green(), l * a.blue() + s * i.blue())
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    initialize: function (e, a) {
                        t.DatasetController.prototype.initialize.call(this, e, a), this.getMeta()
                            .bar = !0
                    },
                    ...
                    calculateBarWidth: function (t) {
                        var e = this.getScaleForId(this.getMeta()
                            .xAxisID);
                    ...
                    draw: function (t) {
                        ...
                        for (e = 0, a = o.length; a > e; ++e) {
                            var l = r.data[e];
                            null === l || void 0 === l || isNaN(l) || o[e].transition(n)
                                .draw()
                        }
                    },
                ...
                a.doughnut = {
                    ...
                    legend: {
                        ...
                        onClick: function (t, e) {
                            var a, i, n, o = e.index,
                                r = this.chart;
                            for (a = 0, i = (r.data.datasets || [])
                                .length; i > a; ++a) n = r.getDatasetMeta(a), n.data[o] && (n.data[o].hidden = !n.data[o].hidden);
                            r.update()
                        }
                    },
                    cutoutPercentage: 50,
                    ...
                    updateElement: function (t, a, i) {
                        ...
                        var v = t._model;
                        this.removeHoverStyle(t), i && s.animateRotate || (0 === a ? v.startAngle = l.rotation : v.startAngle = n.getMeta()
                            .data[a - 1]._model.endAngle, v.endAngle = v.startAngle + v.circumference), t.pivot()
                    },
                    removeHoverStyle: function (e) {
                ...
                t.defaults.line = {
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        if (s.dataset._model.spanGaps && (u = u.filter(function (t) {
                            ...
                            for (e = 0, i = u.length; i > e; ++e) n = u[e], o = n._model, r = a.splineCurve(a.previousItem(u, e)
                                ._model, o, a.nextItem(u, e)
                                    ._model, s.dataset._model.tension), o.controlPointPreviousX = r.previous.x, o.controlPointPreviousY = r.previous.y, o.controlPointNextX = r.next.x, o.controlPointNextY = r.next.y;
                    ...
                    draw: function (t) {
                        ...
                        for (e(n.getDataset(), n.chart.options) && o.dataset.transition(l)
                            .draw(), a = 0, i = r.length; i > a; ++a) r[a].draw()
                    },
                    setHoverStyle: function (t) {
                    ...
                    legend: {
                        ...
                        onClick: function (t, e) {
                            var a, i, n, o = e.index,
                                r = this.chart;
                            for (a = 0, i = (r.data.datasets || [])
                                .length; i > a; ++a) n = r.getDatasetMeta(a), n.data[o].hidden = !n.data[o].hidden;
                            r.update()
                        }
                    },
                    tooltips: {
                ...
                t.defaults.radar = {
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        e.each(a.data, function (i, n) {
                            var o = i._model,
                                r = e.splineCurve(e.previousItem(a.data, n, !0)
                                    ._model, o, e.nextItem(a.data, n, !0)
                                        ._model, o.tension);
                    ...
                    draw: function (t) {
                        ...
                        e.each(a.data, function (t) {
                            t.transition(i)
                        }), a.dataset.transition(i)
                            .draw(), e.each(a.data, function (t) {
                                t.draw()
                            })
                    },
                    setHoverStyle: function (t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (e, a, i) {
                    ...
                    buildScales: function () {
                        var e = this,
                            ...
                            i = e.scales = {},
                            n = [];
                        a.scales && (n = n.concat((a.scales.xAxes || [])
                            .map(function (t) {
                                return {
                                    options: t,
                                    dtype: "category"
                    ...
                    updateDatasets: function () {
                        ...
                        if (t.plugins.notify("beforeDatasetsUpdate", [i])) {
                            for (e = 0, a = i.data.datasets.length; a > e; ++e) i.getDatasetMeta(e)
                                .controller.update();
                    ...
                    draw: function (e) {
                        ...
                        a.clear(), t.plugins.notify("beforeDraw", [a, i]), r.each(a.boxes, function (t) {
                            ...
                            a.isDatasetVisible(i) && a.getDatasetMeta(i)
                                .controller.draw(e)
                        }, a, !0), t.plugins.notify("afterDatasetsDraw", [a, i]), a.tooltip.transition(i)
                            .draw(), t.plugins.notify("afterDraw", [a, i])
                    },
                    ...
                    updateHoverStyle: function (t, e, a) {
                        ...
                        for (n = 0, o = t.length; o > n; ++n) i = t[n], i && this.getDatasetMeta(i._datasetIndex)
                            .controller[r](i)
                    },
                ...
                t.DatasetController = function (t, e) {
                    ...
                    draw: function (t) {
                        var e, a, i = t || 1,
                            n = this.getMeta()
                                .data;
                        for (e = 0, a = n.length; a > e; ++e) n[e].transition(i)
                            .draw()
                    },
        ...
        26: [function (t, e, a) {
            ...
            e.exports = function (t) {
                ...
                o.requestAnimFrame = function () {
                    ...
                    var o = e[n];
                    return o || (o = e[n] = t.measureText(n)
                        .width, a.push(n)), o > i && (i = o), i
                    ...
                    return t instanceof CanvasPattern ? t : o.color(t)
                        .saturate(.5)
                        .darken(.1)
                        .rgbString()
                }
                ...
                t.Interaction = {
                    modes: {
                        ...
                        dataset: function (t, e, n) {
                            ...
                            return l.length > 0 && (l = t.getDatasetMeta(l[0]._datasetIndex)
                                .data), l
                        },
                        "x-axis": function (t, e) {
                            return n(t, e, !0)
            ...
            e.exports = function (t) {
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        ...
                        i.font = d;
                        var u, c = i.measureText(a.ticks[0])
                            .width,
                            h = i.measureText(a.ticks[a.ticks.length - 1])
                                .width;
                    ...
                    fit: function () {
                        ...
                        if (u ? i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth : i.width = d && s.drawTicks ? m : 0, u ? i.height = d && s.drawTicks ? m : 0 : i.height = a.maxHeight, l.display && d && (u ? i.height += 1.5 * p : i.width += 1.5 * p), r.display && d) {
                            ...
                            if (u) {
                                ...
                                var k = a.ctx.measureText(a.ticks[0])
                                    .width,
                    ...
                    n = t.LinearScaleBase.extend({
                        ...
                        fit: function () {
                            ...
                            for (this.ctx.font = v, i = 0; i < this.getValueCount(); i++) {
                                t = this.getPointPosition(i, x), n = this.ctx.measureText(this.pointLabels[i] ? this.pointLabels[i] : "")
                                    .width + 5;
                ...
                var e = t.helpers,
                    ...
                    o = t.Scale.extend({
                        ...
                        getMomentStartOf: function (t) {
                            var e = this;
                            return "week" === e.options.time.unit && e.options.time.isoWeekday !== !1 ? t.clone()
                                .startOf("isoWeek")
                                .isoWeekday(e.options.time.isoWeekday) : t.clone()
                                    .startOf(e.tickUnit)
                        },
                        determineDataLimits: function () {
                            var t = this;
                            ...
                            }, t), t.options.time.min && (t.firstTick = t.parseTime(t.options.time.min)), t.options.time.max && (t.lastTick = t.parseTime(t.options.time.max)), t.firstTick = (t.firstTick || i())
                                .clone(), t.lastTick = (t.lastTick || i())
                                    .clone()
                        },
                            ...
                            if (i.ctx.font = l, i.ticks = [], i.unitScale = 1, i.scaleSizeInUnits = 0, i.options.time.unit) i.tickUnit = i.options.time.unit || "day", i.displayFormat = i.options.time.displayFormats[i.tickUnit], i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0), i.unitScale = e.getValueOrDefault(i.options.time.unitStepSize, 1);
                                ...
                                for (var g = 0, p = a.units[g]; g < a.units.length;) {
                                    ...
                                    var b = i.firstTick.diff(i.getMomentStartOf(i.firstTick), i.tickUnit, !0),
                                        v = i.getMomentStartOf(i.lastTick.clone()
                                            .add(1, i.tickUnit))
                        ...
                        getLabelForIndex: function (t, e) {
                            ...
                            return "object" == typeof a.chart.data.datasets[e].data[0] && (i = a.getRightValue(a.chart.data.datasets[e].data[t])), a.options.time.tooltipFormat && (i = a.parseTime(i)
                                .format(a.options.time.tooltipFormat)), i
                        },
                        ...
                        getValueForPixel: function (t) {
                            ...
                            return n *= e.scaleSizeInUnits, e.firstTick.clone()
                                .add(i.duration(n, e.tickUnit)
                                    .asSeconds(), "seconds")
                        },
